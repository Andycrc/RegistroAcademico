        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <form action="<%= ProjectConstants.rutaBase %>Register" method="POST">
                    ...
                    <!-- ROL USUARIO -->                              
                    <div class="mb-3">
                      <label for="rol" class="form-label">Registrar como: </label>
              ...
              <p class="text-center">
                <span>Ya tienes una cuenta?</span>
                 <a href="<%= ProjectConstants.rutaBase %>index.jsp">
